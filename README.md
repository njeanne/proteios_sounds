...
- `-i --instruments <INT INT INT>`: optional, 3 integers separated by spaces between 0 and 127 to set the instruments on the 3 channels. Default are 91, 53 and 11. See the [General MIDI patch numbers](https://www.perfessorbill.com/lyrics/gsinst.htm) for the correspondances between the integers and the MIDI instruments.
...
[▶️ Watch the video](doc%2FP10145_IL8_HUMAN_Homo_sapiens_thumbnail.png)(https://github.com/njeanne/proteios_sounds/raw/dev/doc/P10145_IL8_HUMAN_Homo_sapiens_100bpm_intrus-91-53-11.mp4)
